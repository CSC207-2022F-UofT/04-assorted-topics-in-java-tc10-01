...
class DrivableMap {
    ...
    public boolean hasFasterThan(int speed) {
        int maxSpeed = 0;
        for (Drivable drivableObject : this.drivable_map.values()) {
            int currSpeed = drivableObject.getMaxSpeed();
